@REM kaitai-struct-compiler launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM KAITAI_STRUCT_COMPILER_config.txt found in the KAITAI_STRUCT_COMPILER_HOME.
...
set "CFG_FILE=%APP_HOME%\KAITAI_STRUCT_COMPILER_config.txt"
set CFG_OPTS=
...
set "APP_CLASSPATH=%APP_LIB_DIR%\io.kaitai.kaitai-struct-compiler-0.11.jar;%APP_LIB_DIR%\org.scala-lang.scala-library-2.13.13.jar;%APP_LIB_DIR%\com.github.scopt.scopt_2.13-4.1.0.jar;%APP_LIB_DIR%\com.lihaoyi.fastparse_2.13-2.3.3.jar;%APP_LIB_DIR%\org.yaml.snakeyaml-2.0.jar;%APP_LIB_DIR%\com.lihaoyi.sourcecode_2.13-0.2.3.jar;%APP_LIB_DIR%\com.lihaoyi.geny_2.13-0.6.10.jar"
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running kaitai-struct-compiler.
  echo.
